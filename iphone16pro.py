...
window = Tk()
window.title("iPhone 16 Pro | Apple savdo")
window.geometry("700x400")
welcome = Label(window, text="iPhone 16 Pro", font=("Arial", 16, "bold"))
...
info = Label(window, text="""Rang: Oltin
Protsessor: A18 Pro
Ekran: 6.1 inch
Kamera: 48mp
AI: Apple Intelligence""", font=("Arial", 13, "normal"))
info.place(x=300, y=90, width=315, height=200)
price = Label(window, text="Narxi: 999$", font=("Arial", 14, "bold"))
