...
window = Tk()
window.title("Macbook Pro M1 | Apple savdo")
...
info = Label(window, text="""Chiqarilgan sana: 2020-yil
Protsessor: Apple M1
Operativ xotira: 8GB / 16GB
Batareya quvvati: ~20 soatgacha""", font=("Arial", 13, "normal"))
info.place(x=300, y=90, width=315, height=200)
price = Label(window, text="Narxi: 700$", font=("Arial", 14, "bold"))
