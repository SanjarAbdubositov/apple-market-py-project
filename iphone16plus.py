...
window = Tk()
window.title("iPhone 16 Plus | Apple savdo")
window.geometry("700x400")

welcome = Label(window, text="iPhone 16 Plus", font=("Arial", 16, "bold"))
